...
typedef BOOL (WGL_APIENTRY *wglShareListsFunc_t)();
typedef HDC (WGL_APIENTRY *wglGetCurrentDCFunc_t)();
...
typedef struct {
	...
	wglSwapLayerBuffersFunc_t wglSwapLayerBuffers;
	wglGetCurrentContextFunc_t wglGetCurrentContext;
	wglGetCurrentDCFunc_t wglGetCurrentDC;
